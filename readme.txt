...
Plugin that allows users to enter the site in one click, using a single account Wargaming.net ID.
...
1. Visit the settings page, it is available in the plugins menu in WordPress
